...
@OnlyIn(Dist.CLIENT)
public class SparkleParticle extends RisingParticle {
    private final IAnimatedSprite spriteWithAge;

    protected SparkleParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, float scale, IAnimatedSprite spriteWithAge) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new SparkleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 0.75F, this.spriteSet);
        }
    }
}